...
COPY public.pedido (id, municipio, ciudad, n_hamburguesas, monto_delivery, monto_total, metodo_pago, estado_delivery, screenshot, fecha, cedula) FROM stdin;
\.
...
ALTER TABLE ONLY public.pedido
    ADD CONSTRAINT fk_cedula FOREIGN KEY (cedula) REFERENCES public.cliente(cedula);
